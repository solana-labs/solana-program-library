...
# First read the package name and current version from Cargo.toml
...
# Increment version in Cargo.toml of the specified package
...
# and update their dependencies to the new version.
declare tomls=()
