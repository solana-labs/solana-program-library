...
import { createTreeOnChain, createTreeWithRoot, execute } from './utils';
...
describe('Account Compression', () => {
  ...
  describe('Initializes a tree with a set root and canopy', () => {
    it('Canopy is initialized with the correct depth and size', async () => {
      const leaves = [
