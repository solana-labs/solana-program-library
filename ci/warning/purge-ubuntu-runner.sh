...
# DISK SPACE ON UBUNTU. IT IS NOT MARKED AS EXECUTABLE BY DEFAULT FOR SAFETY.
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
sudo apt purge aria2 ansible azure-cli shellcheck rpm xorriso zsync \
  ...
  dotnet-sdk-* \
  esl-erlang firefox g++-8 g++-9 gfortran-8 gfortran-9 \
  google-chrome-stable google-cloud-sdk \
  ghc-* \
  cabal-install-* \
  heroku imagemagick \
  libmagickcore-dev libmagickwand-dev libmagic-dev ant ant-optional kubectl \
  mercurial mono-complete mysql-client libmysqlclient-dev \
