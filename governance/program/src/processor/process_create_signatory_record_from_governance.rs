...
use crate::{
    ...
    state::{
        ...
        governance::get_governance_required_signatory_data_for_governance,
...
pub fn process_create_signatory_record_from_governance(
    ...
    let required_signature_record = get_governance_required_signatory_data_for_governance(
        program_id,
    ...
    let signatory_record_data = SignatoryRecordV2 {
        ...
        signatory: required_signature_record.address,
        signed_off: false,
        reserved_v2: [0; 8],
    };
    ...
    create_and_serialize_account_signed::<SignatoryRecordV2>(
        ...
        &get_signatory_record_address_seeds(proposal_info.key, &required_signature_record.address),
        program_id,
        system_program,
        &rent,
        0,
