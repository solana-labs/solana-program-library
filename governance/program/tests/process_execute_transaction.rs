...
async fn test_execute_mint_transaction() {
    ...
    let signatory_record_cookie = governance_test
        .with_signatory(&proposal_cookie, &mint_governance_cookie, &token_owner_record_cookie)
        .await
        .unwrap();
...
async fn test_execute_transfer_transaction() {
    ...
    let signatory_record_cookie = governance_test
        .with_signatory(&proposal_cookie, &token_governance_cookie, &token_owner_record_cookie)
        .await
        .unwrap();
...
async fn test_execute_upgrade_program_transaction() {
    ...
    let signatory_record_cookie = governance_test
        .with_signatory(&proposal_cookie, &program_governance_cookie, &token_owner_record_cookie)
        .await
        .unwrap();
