...
async fn success() {
    ...
    let treasury_fee = Fee {
        numerator: stake_pool.treasury_fee.numerator + 1,
        denominator: stake_pool.treasury_fee.denominator + 1,
    };
    ...
    assert_eq!(stake_pool.treasury_fee, treasury_fee);
}
