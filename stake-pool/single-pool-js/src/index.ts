...
export function findPoolStakeAddress(
  programId: PublicKey,
...
export function findPoolMintAddress(
  programId: PublicKey,
  poolAddress: PublicKey,
) {
...
export function findPoolStakeAuthorityAddress(
  programId: PublicKey,
  poolAddress: PublicKey,
) {
...
export function findPoolMintAuthorityAddress(
  programId: PublicKey,
  poolAddress: PublicKey,
) {
...
export function findPoolMplAuthorityAddress(
  programId: PublicKey,
  poolAddress: PublicKey,
) {
...
async function main() {
    ...
    let airdrop = await connection.requestAirdrop(payer.publicKey, 100 * LAMPORTS_PER_SOL);
    await connection.confirmTransaction(airdrop);

    let voteAccount = new PublicKey("KRAKEnMdmT4EfM8ykTFH6yLoCd5vNLcQvJwF66Y2dag");
