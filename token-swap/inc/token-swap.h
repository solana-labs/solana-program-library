...
#define TOKEN_SWAP_MAJOR_VERSION 0
#define TOKEN_SWAP_MINOR_VERSION 1
#define TOKEN_SWAP_PATCH_VERSION 0
 ...
 */
typedef struct TokenSwap_Invariant TokenSwap_Invariant;
...
typedef enum TokenSwap_SwapInstruction_Tag {
     ...
     */
    TokenSwap_SwapInstruction_Initialize,
    /**
     ...
     */
    TokenSwap_SwapInstruction_Swap,
    /**
     ...
     */
    TokenSwap_SwapInstruction_Deposit,
    /**
     ...
     */
    TokenSwap_SwapInstruction_Withdraw,
} TokenSwap_SwapInstruction_Tag;

typedef struct TokenSwap_SwapInstruction_TokenSwap_Initialize_Body {
    TokenSwap_Fee _0;
} TokenSwap_SwapInstruction_TokenSwap_Initialize_Body;

typedef struct TokenSwap_SwapInstruction_TokenSwap_Swap_Body {
    TokenSwap_U256 _0;
} TokenSwap_SwapInstruction_TokenSwap_Swap_Body;

typedef struct TokenSwap_SwapInstruction_TokenSwap_Deposit_Body {
    TokenSwap_U256 _0;
} TokenSwap_SwapInstruction_TokenSwap_Deposit_Body;

typedef struct TokenSwap_SwapInstruction_TokenSwap_Withdraw_Body {
    TokenSwap_U256 _0;
} TokenSwap_SwapInstruction_TokenSwap_Withdraw_Body;

typedef struct TokenSwap_SwapInstruction {
    TokenSwap_SwapInstruction_Tag tag;
    union {
        TokenSwap_SwapInstruction_TokenSwap_Initialize_Body initialize;
        TokenSwap_SwapInstruction_TokenSwap_Swap_Body swap;
        TokenSwap_SwapInstruction_TokenSwap_Deposit_Body deposit;
        TokenSwap_SwapInstruction_TokenSwap_Withdraw_Body withdraw;
    };
...
typedef enum TokenSwap_State_Tag {
     ...
     */
    TokenSwap_State_Unallocated,
    /**
     * Initialized state.
     */
    TokenSwap_State_Init,
} TokenSwap_State_Tag;

typedef struct TokenSwap_State_TokenSwap_Init_Body {
    TokenSwap_SwapInfo _0;
} TokenSwap_State_TokenSwap_Init_Body;

typedef struct TokenSwap_State {
    TokenSwap_State_Tag tag;
    union {
        TokenSwap_State_TokenSwap_Init_Body init;
    };
} TokenSwap_State;
