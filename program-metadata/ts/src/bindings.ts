...
import { createMetadataEntryIx, deleteMetadataEntryIx, updateMetadataEntryIx } from "./instruction";

export const NS_HASH_PREFIX = "SPL Name Service";
export const NS_PROGRAM_ID = new PublicKey('2eD37nsnRfY7QdymU6GXrkZ7rUhpL6Y29e8K8dhisN7G');

export const METADATA_PREFIX = "program_metadata";
export const PROGRAM_METADATA_ID = new PublicKey('6cQ31NiNjrTTvjFbXiDUxo2ao29jQrGpV2JkN1Ztm2Gy');
