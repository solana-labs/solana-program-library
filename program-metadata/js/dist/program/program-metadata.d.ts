...
export declare class ProgramMetadata {
    ...
    createVersionedIdl(targetProgramId: PublicKey, targetProgramAuthorityKey: PublicKey, payerKey: PublicKey, effectiveSlot: number, idlUrl: string, idlHash: Buffer, sourceUrl: string): Promise<TransactionInstruction>;
    updateVersionedIdl(targetProgramId: PublicKey, targetProgramAuthorityKey: PublicKey, effectiveSlot: number, idlUrl: string, idlHash: Buffer, sourceUrl: string): Promise<TransactionInstruction>;
