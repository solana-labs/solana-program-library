...
class ProgramMetadata {
    ...
    async getClassKey(targetProgramId) {
        const [classKey] = await web3_js_1.PublicKey.findProgramAddress([Buffer.from(exports.METADATA_PREFIX), targetProgramId.toBuffer()], this.programMetadataKey);
        return classKey;
    }
    async getNameKey(hashedName, classKey) {
        const [nameKey] = await web3_js_1.PublicKey.findProgramAddress([hashedName, classKey.toBuffer(), Buffer.alloc(32)], this.nameServiceKey);
        return nameKey;
    }
}
exports.ProgramMetadata = ProgramMetadata;
//# sourceMappingURL=program-metadata.js.map