...
The group extension should work directly with the group-pointer extension.
During mint creation, you should also add the group-pointer extension, pointed
at the mint itself.
...
update authority and the member's number, can be stored directly in the mint
itself.

The member extension should work directly with the member-pointer extension.
During mint creation, you should also add the member-pointer extension, pointed
at the mint itself.
