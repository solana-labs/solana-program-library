...
Javascript bindings are available for [Web3.js Classic](XXX TODO) and [Web3.js Next](XXX TODO).
...
All of these roles can be overrided by command-line flags.
  ...
  <TabItem value="jsx" label="WEB3.JS CLASSIC">
...
You can either get your keypair using [`Keypair`](https://solana-labs.github.io/solana-web3.js/classes/Keypair.html) from `@solana/web3.js`, or let the user's wallet handle the keypair and use `sendTransaction` from [`wallet-adapter`](https://github.com/solana-labs/wallet-adapter)
  ...
  <TabItem value="jsx" label="WEB3.JS NEXT">
#### pnpm
```console
pnpm install XXX TODO
```
...
// sign with the fee payer and authorizedWithdrawer
```
  </TabItem>
