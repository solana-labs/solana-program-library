...
use {
    crate::{
        ...
        native_mint,
        pod::{PodAccount, PodCOptionPubkey, PodCOptionU64, PodMint},
...
impl Processor {
    fn _process_initialize_mint(
        ...
        mint.base.mint_authority = PodCOptionPubkey::some(mint_authority);
    ...
    fn _process_initialize_account(
        ...
        account.base.close_authority = PodCOptionPubkey::none();
        account.base.delegate = PodCOptionPubkey::none();
        ...
        if cmp_pubkeys(mint_info.key, &native_mint::id()) {
            ...
            account.base.is_native = PodCOptionU64::some(rent_exempt_reserve);
            ...
            account.base.is_native = PodCOptionU64::none();
    ...
    pub fn process_approve(
        ...
        source_account.base.delegate = PodCOptionPubkey::some(*delegate_info.key);
