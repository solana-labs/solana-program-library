...
import { decodeApproveInstruction, DecodedApproveInstruction } from './approve.js';
import { decodeApproveCheckedInstruction, DecodedApproveCheckedInstruction } from './approveChecked.js';
import { decodeBurnInstruction, DecodedBurnInstruction } from './burn.js';
import { decodeBurnCheckedInstruction, DecodedBurnCheckedInstruction } from './burnChecked.js';
import { decodeCloseAccountInstruction, DecodedCloseAccountInstruction } from './closeAccount.js';
import { DecodedFreezeAccountInstruction, decodeFreezeAccountInstruction } from './freezeAccount.js';
import { DecodedInitializeAccountInstruction, decodeInitializeAccountInstruction } from './initializeAccount.js';
import { DecodedInitializeAccount2Instruction, decodeInitializeAccount2Instruction } from './initializeAccount2.js';
import { DecodedInitializeAccount3Instruction, decodeInitializeAccount3Instruction } from './initializeAccount3.js';
import { DecodedInitializeMintInstruction, decodeInitializeMintInstruction } from './initializeMint.js';
import { DecodedInitializeMultisigInstruction, decodeInitializeMultisigInstruction } from './initializeMultisig.js';
import { DecodedMintToInstruction, decodeMintToInstruction } from './mintTo.js';
import { DecodedMintToCheckedInstruction, decodeMintToCheckedInstruction } from './mintToChecked.js';
import { DecodedRevokeInstruction, decodeRevokeInstruction } from './revoke.js';
import { DecodedSetAuthorityInstruction, decodeSetAuthorityInstruction } from './setAuthority.js';
import { DecodedSyncNativeInstruction, decodeSyncNativeInstruction } from './syncNative.js';
import { DecodedThawAccountInstruction, decodeThawAccountInstruction } from './thawAccount.js';
import { DecodedTransferInstruction, decodeTransferInstruction } from './transfer.js';
import { DecodedTransferCheckedInstruction, decodeTransferCheckedInstruction } from './transferChecked.js';
